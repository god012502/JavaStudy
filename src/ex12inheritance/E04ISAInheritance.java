...
/*
 	Is-A 관계
 	X is a Y -> X는 Y의 일종이다는 표현가능한 관계
 	- 노트북은 컴퓨터의 일종이다.
 	- 휴대폰은 전화기의 일종이다.
 	이와 같이 Is-A관계가 성립하는 객체를 상속으로 표현하기에 적합하다.
 	따라서 실제 업무에서도 유사한 기능의 클래스들을 
 	상속으로 묶에서 정의하는 것이 좋다
 */
...
//	public Computer() {}
	...
	/*
	 	private 접근지정자로 선언된 멤버메서드는 외부클래스
	...
	/*
	 	...
	 	public으로 지정하여 선언한 메서드
	 	2개의 업무를 하나로 묶었으므로 "캡슐화"되었다고 볼 수 있다
	 */
...
class NotebookComputer extends Computer{
	...
	public void movingCal() {
		//사용 전 배터리를 확인 후 사용여부를 판단
		if(bettery<1) {//배터리가 0이라면
			/*
		...
		/*
		 	...
		 	이 경우 public으로 선언된 메서드를 통해 간접 호출해야 한다.
		 */
//		keyboardTouch(); 에러	
//		calculate(); 발생
		calculateFunc();
...
/*
 	테블릿
 	컴퓨터의 기본 계산기능과, 휴대이용 그리고 전용펜으로 
 	드로잉 할 수 있는 기능까지 추가된 컴퓨터를 표현
 */
...
public class E04ISAInheritance {
	public static void main(String[] args) {
		...
		tablet.write("ISE 1234");//사용 가능
		
		System.out.println("==XYZ 9876 펜으로 테블릿 사용==");
		tablet.write("XYZ 9876");//사용 불가
	}
}
