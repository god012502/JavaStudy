...
/*
 	...
 	따라서 구성(Composition) 관계로 표현하는 것이 적합하다
 	
 	구성관계란 클래스의 멤버로 다른 클래스의 인스턴스를
 	사용하는 것을 말한다.
 */
...
class Police{
	...
	public Police(int bNum, int hCuff) {
		...
		/*
		 	...
		 	참조변수가 null이라는 것은 참조할 인스턴스가 없는 것을 
		 	의미하므로 소유하지 않는 것을 표현할 수가 없다.		 	
		 */
		if(bNum<=0) {
			gun=null;
		}
