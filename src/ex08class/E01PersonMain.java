...
/*
 	추상화(Abstraction)
 	현실세계의 사물을 클래스로 형상화하는 것을 뜻한다.
 	Person 클래스는 "사람"의 일반적인 사항을 클래스로 추상화하고 있다.
 */
/*
 	클래스 선언시 class 예약아를 사용한다.
 	클래스명의 첫글자는 반드시 대문자로 기술해야 한다.
...
class Person{
	...
	/*
	 	...
	 	사람을 추상화한 클래스이므로 이름, 나이 등이 정의되어 있다.
	 */
	String name= "정우성";
	int age=47;
	String gender="남자";
	...
	/*
	 	...
	 	클래스 외부에서 호출시에는 인스턴스 참조변수를 사용해서 .(닷)으로 호출한다.
