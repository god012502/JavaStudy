...
public class Ex03ArrayList2 {
	public static void main(String[] args) {
		/*
		 	아래 2개의 컬렉션은 내부적인 자료구조만 다를 뿐 구현방법에는 차이가 없다.
		 	인스턴스 생성시 Student형의 타입매개변수 통해 생성한다.
		 	Student를 저장할 수 있는 상자가 된다.
		 */
//		ArrayList<Student> list2=new ArrayList<Student>();
		...
		/*
		 	저장할 Student 인스턴스 생성
		 	외부패키지에 선언되었으므로 import후 사용할 수 있다.
		 */
		...
		/*
		 	일반 for문을 사용을 위해 size() 메서드로 추가된 인스턴스의
		 	갯수를 반환받을 수 있다.
		 	인덱스로 접근행 하므로 get() 메서드를 사용한다.
		 */
		...
		for(Student st:list2) {
			/*
			 	...
			 	getter를 통해 접근해야 한다.
			 	삭제를 위해 입력한 이름과 Student인스턴스에 저장된 name과 
			 	일치하는지 확인한 후 해당 인스턴스를 검색할 수 있다.
			 */
		...
		/*
		 * 시나리오]
		 * 컬렉션에 저장된 객체를 이름으로 검색하여 삭제할 수 있는 코드를 작성하시오.
