...
/*
 	...
 	멤버메서드와 완전히 동일한 모양으로 메서드를 재정의 하는 것을 말한다.
 	오버로딩과 다른점은 매개변수의 갯수 및 타입, 반환타입 등이 
 	완전히 똑같은 형태로 정의 된다는 것이다.
...
class Speaker{
	...
	/*
	 	멤버변수 private이므로 외부에서 설정할 수 있도록 
	 	setter 메서드를 정의
	 */
...
//자식클래스 : 기본 스피커에 베이스 기능을 보강한 형태로 정의
...
public class E01Overriding {
	public static void main(String[] args) {
		...
		/*
		 	...
		 	범위가 부모인스턴스로 제한된다.
		 	따라서 자식쪽에 정의된 setBase()는 호출할 수 없다
		 */
