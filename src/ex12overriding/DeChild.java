...
//		System.out.println(name+"이(가) 공부한다.");
	...
	/*
	 	메서드 오버라이딩의 조건
	 	- 부모클래스에 선언될 때와 비교해서 접근범위가 
	 	  동일하거나 그보다 넓으면 가능하다.
	 	- 부모에서 default로 선언하면 자식에서는 
	 	  defalut 혹은 public으로 선언하면 오버라이딩이 가능하다.
	 */
	@Override
	public String sleep() {
	...
	/*
	 	...
	 	클래스 외부(메서드영역)에 미리 로드되므로, 
	 	오버라이딩이 되지않고 호출 할 때 각 클래스명을 사용하면 된다.
	 */
