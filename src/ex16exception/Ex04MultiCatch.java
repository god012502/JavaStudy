...
/*
 	...
 	Exception 클래스는 모든 예외를 처리할 수 있으므로 반드시
 	마지막 블럭에 사용해야 한다.
...
public class Ex04MultiCatch {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			System.out.println("배열에 저잘된 두 숫자 나누기:"+array[0]/array[1]);
			//나이 입력 시 문자를 입력하면 예외가 발생된다.
			...
			/*
				...
				catch절의 마지막에 위치해야 한다.
				앞부분에 있으면 모든 예외를 처리하기 때문에 아래쪽의
				블럭이 실행되지 않기 때문이다.
			 */
		...
		/*
		 	앞 부분에서 예외가 발생하더라도 예외처리를 했으므로 
		 	프로그램은 끝까지 실행된 후 정상적으로 종료된다. 
		 	실행의 흐름이 마지막까지 이어지게 하는것이 "예외처리"의 목적이다.
		 */
