...
/*
 	...
 	예외발생과 상관없이 try문으로 진입했을 때 반드시 실행해야 할 코드가 
 	있는 경우 기술하는 블럭이다.
...
public class Ex05Finally {
	...
	static void tryCatchFinally() {
		...
		try {
			...
			/*
			 	...
			 	finally절이 있다면 해당 구문이 실행 된 후 종료된다.
			 */
			return;
		} 
			...
			/*
			 	...
			 	즉 콘솔창의 터미네이트 버튼을 누르는 것과 동일하게 동작한다.
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	이어지므로 해당 문장이 실행된다.
		 	하지만 exit(0)가 중간에 실행되면 이 부분은 실행될 수 없다.
		 */
