	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		  	...
		  	2개의 인스턴스는 각각 생성되므로 다르다는 결과가 나온다.
		 */
		if(str1==str2) {
		...
		/*
		  	equals() 메서드
		  	Object클래스에서 제공하는 메서드로 실제 저장된 문자열을 비교하도록 정의되어 있다
		  	즉, 아래는 인스턴스에 저장된 실제 문자열에 대한 비교가 이루어진다.
		 */
		if(str1.equals(str2)) {
		...
		/*
		 	String 인스턴스 생성방법2
		 	더블퀘테이션을 사용한다
		 	이 경우 내용이 동일하다면 같은 주소를 사용한다.
		 	즉 새로운 메모리를 할당하지 않는다.
		 	따라서 String 인스턴스는 방법2를 주로 사용한다
		 */
		String str3="자바개발자";
		String str4="자바개발자";
