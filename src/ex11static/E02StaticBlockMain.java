...
public class E02StaticBlockMain {
 /*
   static 블럭
   동일 클래스 내 main() 메서드 보다 먼저 실행되는 블럭이로
  ...
  */
	...
	//static 블럭 정의
	static {
		//블럭 내에서 정적변수에 접근할 수 있다.
		staticVar = 1000;		
		/*
		 	블럭 내에서만 사용할 수 있는 변수로써,
		 	블럭내에서는 일반 변수를 생성할 수 있다.
		 */
		int localVar;
		localVar = 1000;
	...
	/*
	 	static 블럭내에서 선언된 변수는 지역변수이므로
	 	main메서드에서는 사용할 수 없다.
	 	static 블럭 지역내에서만 사용할 수 있다.
	 */
	//	System.out.println("localVar="+ localVar);
