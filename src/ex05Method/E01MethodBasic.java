...
public class E01MethodBasic {
	...
	/*
	 	메소드 2 : 반환값X, 매개변수X
	 	-> 전달받는 값 없이 이름을 입력받은 후 namePrint()메서드를 호출
	 	   이와 같이 반환값이 없는 경우에는 반드시 void를 명시해야 한다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 	메서드를 호출할 때는 매서드의 원형을 그대로 기술한다.
		 	매개변수가 있다면 그 객수만큼 포함해야 한다.
		 	매경변수의 갯수가 다르거나 타입이 틀리면 에러가 발생한다.
		 */
