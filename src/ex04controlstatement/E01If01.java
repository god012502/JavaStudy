...
/*
 	if문 형식1
 	 ...
 	 - 즉 조건의 결과로 true/false를 반환해야 한다.
 	 - 조건문에 산술식이 포함되면 에러가 발생한다.
...
public class E01If01 {
	public static void main(String[] args) throws IOException {
		...
		//if문의 조건식은 아래와 같이 boolean값을 반환해야 한다.
		//비교식으로 처리
		if(num%2==0) {
		...
		/*if(조건식); => 세미콜론은 문장의 끝을 나타내므로 조건에 상관없이 중괄호에 있는 문장이 실행된다.
		  				따라서 사용에 주의해야 한다.
		  				*/
		if(num%2 != 0);
		{
		...
		/*
		 	아스키코드를 알고있을 때의 구현방법.
		 	문자 0과 9는 아스키코드 48, 57에 해당하므로 구간내에 있는지 확인하면 된다.
		 */
		...
		/*
		 	아스키코드를 모를 때 구현하는 방법
		 	문자 '0'과 '9'는 메모리에 저장 시 아스키코드로 변환되므로
		 	아래와 같은 조건으로도 확인 할 수 있다.
		 */
