...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException{
		...
		/*
		 	시나리오] E03 예제의 1~10까지의 더하는 수업문제를 do~whileansdmfh 
		 			변경하여 구현하시오.
		 */
		...
		/*
		 	시나리오] 1부터 1000까지의 정수 중 4의 배수이거나 7의 배수인 수의 합을 구하여 
		 			출력하는 프로그램을 작성하시오.
		...
		do{
			...
			System.out.println("계속하려면 x(X)를 입력하세요.");
			System.out.println("계속하려면 아무거나 입력하세요");
