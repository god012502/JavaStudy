package ex10accessmodier;
/*
 	캡슐화(Encapsulation)
 	여러가지 업무 로직을 하나로 묶는다는 의미와 업무의 순서까지 
 	고려한 형태의 로직을 구성한다는 의미를 가지고 있다
...
class CongratulationPoint{
	void doCongratulationPoint() {
		System.out.println("3. 가입축하 10포인트를 지급한다.");
	}
}
class AutoLogin{
	void doAutoLogin() {
...
/*
	업무의 순서를 고려하여 관련된 메서드를 하나의 클래스를 정의한다.
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		/*
		 	업무의 진행순서가 중요하다고 가정해을 때 캡슐화 이전의 
