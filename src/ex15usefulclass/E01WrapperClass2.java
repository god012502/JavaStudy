...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("10+strNumber="+(10+Integer.valueOf(strNumber)));
		
		/*
		 	문자열을 숫자로 변경 시 반드시 숫자형식만 기술해야한다.
		 	'원'은 숫자가 아니므로 변경시 예외가 발생한다.
		 */
		String money="120원";
//		System.out.println("120원:"+Integer.parseInt(money)); 예외발생
		
		/*
		 	실수형태의 문자열을 숫자로 변경할 때는 parseInt()는 사용할 수 없다. 
		 	앞과 동일한 예외가 발생된다.
		 */
...
//		System.out.println(Integer.parseInt(floatString));
		...
		*/
		...
		/*
		 	...
		 	isUpperCase() : 대문자인지 판단. 단 영문이 아닌 경우 false를 반환한다. 
		 */
		...
		/*
		 	시나리오]
		 			...
		 			프로그램을 작성하시오.
		 			참고) toCharArray() 
		 				 문자열을 char형 배열로 반환해주는 String클래스에 정의된 메소드
		 */
		...
		System.out.println("총 공백 수 : "+whiteCnt);	
	}
}
