...
public class E01OneDimArray01 {
	public static void main(String[] args) {
		...
		//배열의 각 원소를 출력
		for(int i=0; i<40; i++) {
			System.out.println(i+"번 방의 값 = "+arrNumber);
		}
		System.out.println("====================================");		
		/*
		 	인스턴스 배열
		 	기본자료형을 저장하는 배열이 아닌 
		 	인스턴스의 참조값을 저장할 목적으로 생성한 배열
		 	사용법은 동일하다.
		 */
		...
		//인덱스로 이용해서 출력
		System.out.println("initArr[0] = "+initArr);
		
		System.out.println("방법 2 : 선언과 동시에 초기화 1");
		
		/*
		 	배열의 선언과 동시에 초기화 하는 경우
		 	자바 컴파일러는 초기값의 객수를 통해 배열의 크기를 결정할 수 있다.
		 	따라서 이런 경우에는 크기를 생략하도록 약속되어 있다.
		 */
