...
public class E01OneDimArray02 {
	public static void main(String[] args) {
		/*
		 	...
		 	반환한다. 정수형태의 난수가 필요하다면 10,100과 같은 정수를 곱해주면 된다.
		 */
		double rndNumber = Math.random();
		System.out.println("생성된 난수[실수] : "+rndNumber);
		
		//정수와 실수의 연산은 실수가 반환되므로 int로 강제 형변환 한다.
		...
		/*
		 	난수 생성 방법 2
		 	Random 클래스를 사용한다.
		 	사용법은 Scanner클래스와 동일하게 정수형 난수를 생성하고 싶다면 
		 	nextInt()를 호출한다.
		 */
		...
		/*
		 	...
		 	1. 0.xxx 형태의 난수를 생성한 후 정수로 변경하기 위해 100을 곱해준다.
		 	2. 45로 %연산하여 나머지를 구한다.
		 	   정수를 45로 나누면 나머지는 0~44사이가 된다.
		 	3. 0은 구간에 포함되지 않으므로 결과에 1을 더해준다.
		 	4. 마지막으로 정수로 만들어주기 위해 강제 형변환 한다.
		 */
