...
class FruitSeller {
		/*
		 	...
		 	이렇게 하면 클래스 내부에서만 접근할 수 있고, 외부에서의 접근은
		 	원천적으로 차단할 수 있다.
		 */
...
public class E03InfomationHiding {
	public static void main(String[] args) {
		...
		FruitSeller seller1 = new FruitSeller(3,100,1000);
...
//		buyer.myMoney-=1000;//구매자의 금액차감
//		seller1.numOfApple-=50;//사과 50개구매
