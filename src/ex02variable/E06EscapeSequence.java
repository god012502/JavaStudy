...
//		줄바꿈(Line feed 가능)		
		System.out.println("Java World에 오신 걸 환영합니다.\n");
		System.out.println("열심히\n해봅시다.\n");
		
//		문자열 사이에 더블퀘테이션을 표현하고 싶을 때 사용
//		System.out.println("나는 "개발자"가 되고싶어요");
		System.out.println("나는 \"개발자가\"가 되고싶어요");
...
//		기술해야 하므로 조금 더 복잡하다.
		...
		/*
		 실수는 %f를 사용
		 또한 정수와 실수의 연산이므로 결과는 실수가 반환되어 double 타입으로 선언한 변수에 대입.
		 */
		...
		/*
		 ...
		 %6.2f : 실수 출력시 전체 자리수는 6자리, 소수이하 2자리로 표현
