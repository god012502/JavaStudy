...
public class E04StringType {
	public static void main(String[] args) {
		/*
		 String 클래스 : 참조형 변수로써 기본 자료형이 아닌 클래스로 문자열을 저장하고, 조작하는 기능을 가지고 있다
		   			   Java에서는 문자열을 표현할 때 "으로 감싸주면 되고 연결시에는 + 기호를 사용한다.
		 */
		...
		number=99;
		/*
		 클래스를 통해 생성한 참조형 변수와 기본자료형 변수 사이에는 형변환이 불가능하다.
		...
		/*
		 문자열 + 정수 : 우선순위가 없다면 문자열과 숫자가 연결된 상태로 출력
		  			  ...
		  			  아래와 같이 소괄호로 묶어 우선순위에 대한 변화를 주면 된다.
		 */
