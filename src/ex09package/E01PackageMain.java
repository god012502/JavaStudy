...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		/*
		 	하나의 클래스 안에 패키지는 다르나 같은 이름의 클래스를 
		 	사용해야 한다면...
		 	
		 	방법1 : 클래스명 앞에 풀 패키지 경로를 기술한다.
		 	방법2 : 하나의 클래스는 import하고, 
		 		   다른 하나는 풀 패키지 경로를 기술한다.
		...
		/*
		 	클래스 사용 시 패키지명까지 모두 입력한 상태로 메서드를 
		 	호출할 수 있다.
		 	이 경우에는 별도의 import가 필요하지 않다.
		 */
		System.out.println(
